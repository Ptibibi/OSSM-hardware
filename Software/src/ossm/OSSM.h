        ...
        auto operator()() const {
            ...
            // clang-format off
                ...
                *"idle"_s + done / drawHello = "homing"_s,
                ...
                "strokeEngine"_s / (resetSettings, startStrokeEngine, drawPatternControls) = "strokeEngine.pattern"_s,
                "strokeEngine.pattern"_s + buttonPress / (drawPreflight) = "strokeEngine.preflight"_s,
                "strokeEngine.pattern"_s + doublePress / (setNotHomed) = "strokeEngine"_s,
                "strokeEngine.pattern"_s + longPress / (emergencyStop, setNotHomed) = "menu"_s,
                "strokeEngine.preflight"_s + done / (drawPlayControls) = "strokeEngine.idle"_s,
